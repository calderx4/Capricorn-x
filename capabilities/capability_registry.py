...
class CapabilityRegistry:
    ...
    @classmethod
    async def create(cls, mcp_servers: Dict[str, Any] = None, workspace_root: str = "./workspace", sandbox: bool = True, skill_manager=None, blocked_commands: list = None, allowed_commands: list = None) -> "CapabilityRegistry":
        registry = cls()
        ...
        registry._allowed_commands = allowed_commands or []
